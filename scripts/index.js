...
for (let i = 0; i < data.events.length; i++) {
  ...
  p.innerHTML = data.events[i].description;
  h5.innerHTML = data.events[i].name;
  image.setAttribute("src", data.events[i].image);
  image.setAttribute("alt", data.events[i].name);
